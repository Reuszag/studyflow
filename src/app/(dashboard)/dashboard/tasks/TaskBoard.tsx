                    ...
                    <div className="flex items-center gap-3 px-2 pb-3 sm:pb-0 shrink-0 border-t border-white/5 sm:border-none pt-3 sm:pt-0 mt-2 sm:mt-0 relative z-10 w-full sm:w-auto">
                        ...
                        <div className="relative flex-1 sm:min-w-[125px]">
                            ...
                            <button 
                                ...
                                className={`w-full flex items-center justify-between bg-[#161822] border border-white/10 rounded-xl px-3.5 py-2.5 text-xs font-semibold hover:bg-white/5 hover:border-white/20 transition-all shadow-sm group ${
                                    formPriority === 'high' ? 'text-red-400' : 
                                ...
                                {columnTasks.length === 0 ? (
                                    ...
                                    columnTasks.map(task => (
                                        <div 
                                            ...
                                            className={`group relative flex flex-col gap-3 p-4 rounded-xl border transition-all duration-200 cursor-grab active:cursor-grabbing hover:-translate-y-0.5 shadow-md ${
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1 min-w-0 pr-6">
                                                    <h4 className={`text-sm font-medium leading-snug ${
                                                        task.status === 'completed' ? 'text-gray-400 line-through decoration-gray-600' : 'text-gray-200'
                                                    }`}>
                                                        {task.title}
                                                    </h4>
                                                </div>
